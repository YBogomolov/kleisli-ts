...
const isImpure =
  <F extends URIS2, G extends URIS2, E, A, B>(a: BiKleisliIO<F, G, E, A, B>): a is Impure<F, G, E, A, B> =>
    a.tag === 'Impure';
 ...
 */
export const pure = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B>(f: (a: Kind2<F, E, A>) => Kind2<G, E, B>): BiKleisliIO<F, G, E, A, B> =>
 ...
 */
export const impure = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E>(catcher: (e: Error) => E) => <A, B>(f: (a: A) => B): BiKleisliIO<F, G, E, A, B> => new Impure(W, M, T, (a: A) => {
    try {
      return f(a);
    } catch (error) {
 ...
 */
export const impureVoid = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B>(f: (a: A) => B): BiKleisliIO<F, G, E, A, B> => impure(W, M, T)(voidCatcher)(f);

/**
 * Lift the impure computation into `BiKleisliIO` context.
 * @param f Impure function from `A` to `B`
 */
export const liftK = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B>(f: (a: A) => B): BiKleisliIO<F, G, E, A, B> => new Impure(W, M, T, f);
...
export const chain = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B, C>(fa: BiKleisliIO<F, G, E, A, B>, f: (b: B) => BiKleisliIO<F, G, E, A, C>): BiKleisliIO<F, G, E, A, C> =>
    pure(W, M, T)<E, A, C>((a) => M.chain(fa.run(a), (b) => f(b).run(a)));

/**
 * Create a new `BiKleisliIO` computation which result in `b`.
 * @param b Lazy value of type `B`
 */
export const point = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B>(b: () => B): BiKleisliIO<F, G, E, A, B> => liftK(W, M, T)(b);
 ...
 */
export const of = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B>(b: B): BiKleisliIO<F, G, E, A, B> => liftK(W, M, T)(() => b);

/**
 * Tuple swap, lifted in `BiKleisliIO` context.
 */
export const swap = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B>(): BiKleisliIO<F, G, E, [A, B], [B, A]> => liftK(W, M, T)(([a, b]) => [b, a]);
 ...
 */
export const composeK = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B, C>(second: BiKleisliIO<F, G, E, B, C>, first: BiKleisliIO<F, G, E, A, B>): BiKleisliIO<F, G, E, A, C> =>
 ...
 * @param second Second computation to apply
 */
export const pipeK = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B, C>(first: BiKleisliIO<F, G, E, A, B>, second: BiKleisliIO<F, G, E, B, C>): BiKleisliIO<F, G, E, A, C> =>
 ...
 */
export const switchK = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B, C>(l: BiKleisliIO<F, G, E, A, B>, r: BiKleisliIO<F, G, E, C, B>): BiKleisliIO<F, G, E, Either<A, C>, B> =>
 ...
 * @param f Function to process the results of both computations
 */
export const zipWith = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B, C, D>(l: BiKleisliIO<F, G, E, A, B>, r: BiKleisliIO<F, G, E, A, C>) =>
 ...
 */
export const identity = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A>(): BiKleisliIO<F, G, E, A, A> => liftK(W, M, T)((x) => x);
 ...
 */
export const left = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B, C>(k: BiKleisliIO<F, G, E, A, B>): BiKleisliIO<F, G, E, Either<A, C>, Either<B, C>> =>
    isImpure(k) ?
 ...
 * @param k Computation from `A` to `B`
 */
export const right = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B, C>(k: BiKleisliIO<F, G, E, A, B>): BiKleisliIO<F, G, E, Either<C, A>, Either<C, B>> =>
    isImpure(k) ?
 ...
 */
export const test = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A>(cond: BiKleisliIO<F, G, E, A, boolean>): BiKleisliIO<F, G, E, A, Either<A, A>> =>
 ...
 */
export const ifThenElse = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B>(cond: BiKleisliIO<F, G, E, A, boolean>) =>
 ...
 * @param then Computation to run if `cond` is `true`
 */
export const ifThen = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A>(cond: BiKleisliIO<F, G, E, A, boolean>) =>
 ...
 */
export const whileDo = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A>(cond: BiKleisliIO<F, G, E, A, boolean>) => (body: BiKleisliIO<F, G, E, A, A>): BiKleisliIO<F, G, E, A, A> => {
 ...
 */
export const fst = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B>(): BiKleisliIO<F, G, E, [A, B], A> => liftK(W, M, T)(([a]) => a);

/**
 * Lifted version of `snd` tuple function.
 */
export const snd = <F extends URIS2, G extends URIS2>(W: Comonad2<F>, M: Monad2<G>, T: Distributes22<F, G>) =>
  <E, A, B>(): BiKleisliIO<F, G, E, [A, B], B> => liftK(W, M, T)(([, b]) => b);

/**
 * Convenience method which retruns instances of Kleisli API for the given monad.
 * @param M Monad2 & Bifunctor instance
 */
export const getInstancesFor = <F extends URIS2, G extends URIS2>(
  W: Comonad2<F>,
  M: Monad2<G>,
  T: Distributes22<F, G>,
) => ({
